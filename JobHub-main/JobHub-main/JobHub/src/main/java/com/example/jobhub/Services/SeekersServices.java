...
public class SeekersServices {
    ...
    public Seekers addSeekers(Seekers seekers  ){
        Seekers seekers1 =seekersRepository.save(seekers);
        return  seekers1;
    }
    public Seekers  updateSeeker(Seekers seekers , Integer id) {
...
//      seekers1.se(seekers.getResume());
        seekersRepository.save(seekers1);
        return seekers1;}
    public Seekers deleteSeeker(Integer id){
